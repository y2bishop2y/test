...
-(void) initOpenGL 
{
	MNLOG(@"INFO - ES1Renderer: Initializing OpenGL");
	
	// Switch to GL_PROJECTION matrix mode and reset the current matrix with the 
	// identity matrix
	...
	// We are not using the depth buffer in our 2D game so depth testing can be 
	// disabled. If depth testing was required then a depth buffer would need to 
	// be created as well as enabling the depth test
